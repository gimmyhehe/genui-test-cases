...
If you want to use GenUI SDK in your own project, please refer to the official  
[Quick Start](https://docs.opentiny.design/genui-sdk/guide/quick-start.html) guide and the  
[Server package usage](https://docs.opentiny.design/genui-sdk/guide/server-usage.html) documentation.
